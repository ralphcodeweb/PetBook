			...
			<div class="card">
				<div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        id="contenidoPublic"
                        placeholder="ingrese el contenido completo de la publicación">{{ old('body') }}</textarea>
			...
			<div class="card">
				<div class="card-body">
					<div class="form-group">
		                ...
		                id="extractoPublic"
		                placeholder="ingrese un pequeño extracto de la publicación">{{ old('excerpt') }}</textarea>
